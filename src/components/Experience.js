  ...
  return (
    ...
    >
      ...
      >
        ...
        <ul>
          <li className="font-medium w-full md:text-sm">{bullet1}</li>
          <li className="font-medium w-full md:text-sm">{bullet2}</li>
          <li className="font-medium w-full md:text-sm">{bullet3}</li>
          <li className="font-medium w-full md:text-sm">{bullet4}</li>
          <li className="font-medium w-full md:text-sm">{bullet5}</li>
        </ul>

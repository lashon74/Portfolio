    ...
    <div className="my-64">
      ...
      <div ref={ref} className="relative w-[75%] mx-auto lg:w-[90%] md:w-full">
        ...
        <ul className="w-full flex flex-col items-start justify-between ml-4">
          <Details
            type="Bachelor of Science in Computer Science & Technology"
            time="2014-2017"
            place="Savannah State University"
            info="Relevant courses: Data Structures and Algorithms, Computer Systems Engineering, Operating Systems, Database Managment, Advance Java, Testing & Verification, Quality Assurance, Project Managment, Architecture, and Visual Basic for Applications."
          />
